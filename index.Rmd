...
```{r banned, echo = FALSE, warning = FALSE, message = FALSE }
banned_clothes %>%
...
rename(aggregate_table, clothing_item = slug)
rename(aggregate_table, number_schools = n)
rename(aggregate_table, gender = market)
```
